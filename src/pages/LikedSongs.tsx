...
const LikedSongsPage = () => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-purple-900/20 to-black pb-32">
      ...
      <div className="sticky top-0 z-10 bg-black/80 backdrop-blur-xl border-b border-pink-500/20">
        <div className="px-4 py-3">
          <div className="flex items-center gap-3">
            <button
              onClick={() => navigate(-1)}
              className="w-10 h-10 bg-black/60 backdrop-blur-sm border border-pink-500/30 rounded-full flex items-center justify-center active:bg-pink-900/30 transition-all active:scale-95"
            >
              <ChevronLeft className="w-5 h-5 text-white" />
            </button>
            <div className="flex-1">
              <h1 className="text-xl font-bold bg-linear-to-r from-pink-400 to-purple-300 bg-clip-text text-transparent">
                Lagu Favorit
              </h1>
            ...
            <div className="w-10 h-10 rounded-xl bg-linear-to-br from-pink-500/20 to-purple-500/20 flex items-center justify-center border border-pink-500/30">
      ...
      <div className="p-4">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <div className="px-2 py-1 bg-black/40 rounded-full border border-pink-500/30">
        ...
        <div className="grid grid-cols-2 gap-2 mb-4">
          <button
            ...
            className="bg-linear-to-r from-pink-600 to-purple-600 active:from-pink-500 active:to-purple-500 text-white font-medium py-3 rounded-xl transition-all active:scale-[0.98] flex items-center justify-center gap-2"
          >
          ...
          <button
            ...
            className="bg-black/60 backdrop-blur-sm border border-pink-500/30 active:border-pink-500/50 text-white font-medium py-3 rounded-xl transition-all flex items-center justify-center gap-2"
          >
        ...
        {currentSongs.length === 0 ? (
          <div className="text-center py-12">
            <div className="w-16 h-16 mx-auto mb-3 rounded-xl bg-linear-to-br from-pink-500/10 to-purple-500/10 flex items-center justify-center border border-pink-500/20">
            ...
            <button
              ...
              className="px-4 py-2 bg-linear-to-r from-pink-600 to-purple-600 text-white rounded-lg text-xs font-medium active:from-pink-500 active:to-purple-500 transition-all"
            >
              Telusuri Lagu
            </button>
          </div>
          ...
          <div className="space-y-2">
            {currentSongs.map((song) => (
              <div
                ...
                className="bg-black/60 backdrop-blur-lg rounded-xl p-3 border border-pink-500/20 active:bg-black/80 transition-all duration-200"
              >
                <div className="flex items-center gap-3">
                  {/* Album Art with Play Button Overlay */}
                  <div className="relative shrink-0">
                    <div className="w-14 h-14 rounded-lg overflow-hidden border border-pink-500/30">
                      <img
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-1">
                      {song.genre && (
                        <span className="text-[10px] px-1.5 py-0.5 bg-linear-to-r from-pink-500/10 to-purple-500/10 rounded-full text-pink-300 border border-pink-500/20">
                          {song.genre}
                        </span>
                      )}
        ...
        {totalPages > 1 && (
          <div className="mt-6 backdrop-blur-lg rounded-xl p-3 border border-pink-500/20">
            <div className="flex items-center justify-between">
              <button
                onClick={() => handlePageChange(currentPage - 1)}
                disabled={currentPage === 1}
                className="w-9 h-9 bg-black/40 border border-pink-500/30 rounded-lg flex items-center justify-center active:bg-pink-900/30 disabled:opacity-50 disabled:active:bg-transparent transition-all"
              >
                    ...
                    <button
                      ...
                      className={`w-9 h-9 rounded-lg text-sm font-medium transition-all ${
                        currentPage === pageNum
                          ...
                          : "bg-black/40 hover:bg-pink-900/30 text-gray-300"
                      }`}
                    >
                      {pageNum}
                    </button>
        ...
        <div className="mt-4 text-center">
          <p className="text-xs text-gray-500">
            {currentSongs.length} dari {totalSongs} lagu favorit
          </p>
        </div>
      </div>
    </div>
