    ...
    <div className="min-h-screen bg-linear-to-br from-gray-900 via-purple-900/20 to-black pb-32 relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="p-5 border-b border-purple-500/20">
          ...
          <div className="flex items-center justify-between mb-4">
            <div className="flex items-center gap-3">
              <div className="px-3 py-1 bg-black/40 rounded-full border border-purple-500/30">
              ...
              <div className="flex items-center gap-1 text-xs text-gray-500">
                ...
                <span>Paling sering diputar</span>
              </div>
            </div>
          ...
          <div className="flex gap-3 mb-6">
            ...
            <button
              ...
              className="flex-1 bg-black/60 backdrop-blur-sm border border-purple-500/30 hover:border-purple-500/50 text-white font-medium py-3.5 rounded-xl transition-all duration-200 flex items-center justify-center gap-2"
            >
        ...
        <div className="p-5">
          {currentSongs.length === 0 ? (
            <div className="text-center py-16">
              <div className="w-20 h-20 mx-auto mb-4 rounded-2xl bg-linear-to-br from-purple-500/10 to-pink-500/10 flex items-center justify-center border border-purple-500/20">
            ...
            <div className="space-y-3">
              {currentSongs.map((song, index) => (
                <div
                  ...
                  className="bg-black/60 backdrop-blur-lg rounded-2xl p-4 border border-purple-500/20 hover:border-purple-500/40 hover:shadow-lg hover:shadow-purple-900/20 transition-all duration-300 cursor-pointer group"
                >
                  <div className="flex items-center gap-4">
                    {/* Song Number */}
                    <div className="shrink-0 w-8">
                      <div className="w-8 h-8 rounded-lg bg-linear-to-br from-purple-500/10 to-pink-500/10 flex items-center justify-center border border-purple-500/20">
                    ...
                    <div className="relative shrink-0">
                      <div className="relative">
                        <div className="w-14 h-14 rounded-xl overflow-hidden border border-purple-500/30">
                          <img
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        {song.genre && (
                          <span className="text-xs px-2 py-1 bg-linear-to-r from-purple-500/10 to-pink-500/10 rounded-full text-purple-300 border border-purple-500/20">
                            {song.genre}
                          </span>
                        )}
                        {song.popularity && (
                      ...
                      <button
                        ...
                        className={`p-2 rounded-xl transition-all duration-200 ${
                          song.is_liked
                            ...
                            : "bg-black/40 hover:bg-purple-900/30 text-gray-400 border border-gray-800 hover:border-purple-500/30"
                        }`}
                      >
          ...
          {/* Pagination */}
          {totalPages > 1 && (
            <div className="mt-8 bg-black/60 backdrop-blur-lg rounded-2xl p-4 border border-purple-500/20">
              <div className="flex items-center justify-between">
                <button
                  onClick={() => handlePageChange(currentPage - 1)}
                  disabled={currentPage === 1}
                  className="w-10 h-10 bg-black/40 border border-purple-500/30 rounded-xl flex items-center justify-center hover:bg-purple-900/30 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                >
                  <ChevronLeft className="w-5 h-5 text-white" />
                </button>
                      ...
                      <button
                        ...
                        className={`w-10 h-10 rounded-xl font-medium transition-all duration-200 ${
                          currentPage === pageNum
                            ...
                            : "bg-black/40 hover:bg-purple-900/30 text-gray-300 border border-gray-800"
                        }`}
                      >
                        {pageNum}
                      </button>
